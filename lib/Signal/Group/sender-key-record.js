...
class SenderKeyRecord {
    constructor(serialized) {
        ...
        if (serialized) {
            try {
                ...
                console.warn('[SenderKeyRecord] Error al deserializar, creando nuevo:', e.message);
                this.senderKeyStates = [];
            }
        }
    }
    ...
    serialize() {
        try {
            ...
            console.warn('[SenderKeyRecord] Error al serializar:', e.message);
            return [];
        }
    }
    static deserialize(data) {
        try {
            ...
            console.warn('[SenderKeyRecord] Deserialización fallida, creando registro nuevo:', e.message);
