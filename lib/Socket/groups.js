...
// TTL del cache interno de metadata de grupo usado por groupMetadataCached/isGroupAdmin/getGroupAdmins/resolveParticipantJid.
...
export const makeGroupsSocket = (config) => {
    ...
    // El cache se invalida solo con los eventos nativos de Baileys (altas/bajas/ascensos/descensos
    // de participantes), así isGroupAdmin/getGroupAdmins/resolveParticipantJid nunca quedan con datos viejos.
     ...
     * Primero busca en los participantes del grupo (jid, lid, phoneNumber); si no encuentra
     * coincidencia, cae al mapeo LID↔PN nativo de Baileys (signalRepository.lidMapping),
     * que es la fuente de verdad real de WhatsApp — nunca lo resuelve "a mano".
     * @param jidOrChatId chat del grupo (string) o un array de participantes ya obtenido
     * @param targetJid jid/lid a resolver
     */
    ...
    /**
     * true si el jid (número o @lid) es admin/superadmin del grupo. Usa metadata cacheada
     * y compara contra id/lid/phoneNumber del participante, que es como WhatsApp realmente
     * identifica administradores en grupos con direccionamiento LID.
     */
    ...
    return {
        ...
        groupParticipantsUpdate: async (jid, participants, action) => {
            ...
            // Invalida el cache al instante: no esperamos al round-trip de la notificación
            // del servidor para que isGroupAdmin/getGroupAdmins reflejen el cambio.
