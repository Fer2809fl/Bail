...
let sharpPromise, ffmpegPromise;

const loadSharp = () => sharpPromise ??= import('sharp').then((m) => m.default).catch(() => {
...
const loadFfmpeg = () => ffmpegPromise ??= import('fluent-ffmpeg').then((m) => m.default).catch(() => {
